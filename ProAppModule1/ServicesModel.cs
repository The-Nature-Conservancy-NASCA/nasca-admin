...
namespace ProAppModule1
{
    ...
    public class Cobertura {
        ...
        private int _fecha_establecimiento;
        private int _edad;
        ...
        public int fecha_establecimiento { get => _fecha_establecimiento; set { _fecha_establecimiento = value; } }
        ...
        public Cobertura(Row row)
        {
            ...
            _fecha_establecimiento = Convert.ToInt32(row["fecha_establecimiento"]);
    ...
    public class Carbono {
        ...
        public string ID_region { get => _ID_region; set { _ID_region = value; } }
        public double fecha { get => _fecha; set { _fecha = value; } }
        public int snc { get => _snc; set { _snc = value; } }
        public string ID_cobertura { get => _ID_cobertura; set { _ID_cobertura = value; } }
