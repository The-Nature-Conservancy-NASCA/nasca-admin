...
namespace ProAppModule1
{
    public class Contribucion : Element
    {
        ...
        private CrearContribucion crearElemento = null; // create new element window
        private EditarContribucion editarElemento = null; // update element window

        // constructor
        public Contribucion(Proyecto proyecto) : base()
        {
            Index = 9;
            SelectedIndex = -1;
            OidField = "OBJECTID";
        ...
        {
            {
                if (crearElemento != null)
                    return;
                crearElemento = new CrearContribucion { Owner = Application.Current.MainWindow };
        ...
        {
            {
                ...
                if (editarElemento != null)
                    return;
                editarElemento = new EditarContribucion { Owner = Application.Current.MainWindow };
